...
class ImprovedEuler(NumericMethods):
    ...
    def aproximate_point(self, massive, x0, X, h):
        if X - h >= x0:
            ...
            massive[1].append(massive[1][-1] + (h/2)*(Function.differential(x0, massive[1][-1]) + Function.differential(x0+h, massive[1][-1] + h*Function.differential(x0, massive[1][-1]))))
